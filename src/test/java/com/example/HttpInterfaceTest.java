...
public class HttpInterfaceTest {
    ...
    public static void setup() throws InterruptedException {
        ...
        CompletionStage<ServerBinding> bindingFuture = http.newServerAt("127.0.0.1", 0)
    ...
    public void testHelloEndpoint() {
        ...
        String responseBody = Unmarshaller.entityToString()
    ...
    public void testPostEndpoint() throws Exception {
        ...
        HttpRequest request = HttpRequest.POST(baseUrl + "/post/" + param)
